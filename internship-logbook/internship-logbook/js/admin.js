      ...
      >
        ...
        <div class="modal-form-grid">
          ...
          <div class="form-group">
            ...
            <label for="newStudentCompany">
              Company
            </label>

            <input
              type="text"
              id="newStudentCompany"
              name="company"
      ...
      >
        ...
        <div class="modal-form-grid">
          ...
          <div class="form-group">
            ...
            <label for="newSupervisorStatus">
              Status
            </label>

            <select
              id="newSupervisorStatus"
              name="status"
            >
...
function openAddInternshipModal() {
  openModal(
    "Add Internship Placement",
    "Create a new student internship placement.",
    `
      <form
        class="modal-form"
        id="addInternshipForm"
      >
        ...
        <div class="modal-form-grid">
          ...
          <div class="form-group">
            ...
            <label for="newInternshipStudent">
              Student
            </label>

            <input
              type="text"
              id="newInternshipStudent"
              name="studentName"
              placeholder="Enter student name"
              required
            >
          ...
          <div class="form-group">
            ...
            <label for="newInternshipCompany">
              Company
            </label>

            <input
              type="text"
              id="newInternshipCompany"
              name="company"
              placeholder="Enter company"
              required
            >
          ...
          <div class="form-group">
            ...
            <label for="newInternshipSupervisor">
              Supervisor
            </label>

            <input
              type="text"
              id="newInternshipSupervisor"
              name="supervisorName"
          ...
          <div class="form-group">
            ...
            <label for="newInternshipStatus">
              Status
            </label>

            <select
              id="newInternshipStatus"
              name="status"
            >
          ...
          <div class="form-group">
            ...
            <label for="newInternshipStart">
              Start Date
            </label>

            <input
              type="date"
              id="newInternshipStart"
              name="startDate"
              required
            >
...
document.addEventListener("submit", function (event) {
  ...
  if (form.id === "addStudentForm") {
    ...
    adminState.students.push(student);

    renderStudents(adminState.students);
  ...
  if (form.id === "addSupervisorForm") {
    ...
    adminState.supervisors.push(supervisor);

    renderSupervisors(adminState.supervisors);
  ...
  if (form.id === "addInternshipForm") {
    ...
    adminState.internships.push(internship);

    renderInternships(adminState.internships);

    closeModal();

    alert("Internship placement added successfully.");
